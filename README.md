...
For naming color-variables we recommend using "real" names generated by [Name Those Colors](http://www.noxproductions.se/namethosecolors/)
...
```css
$bitter-lemon: #dde80c; // Darker yellow
